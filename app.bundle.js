...
const App = () => {
  ...
  return React.createElement("div", {
    ...
    simValues: simValues,
    setSimValues: setSimValues
  }), React.createElement(TeamSection, null), React.createElement(DeliveriesSection, null), React.createElement(FAQ, null), React.createElement(FinalCTA, null), React.createElement(Footer, null), React.createElement(WhatsFloat, null));
};
